...
In [the previous chapter](#initialization) we initialized Phaser and placed a canvas in our screen. In this chapter we're going to load the assets needed by our game.
...
A> Anecdote: While I was developing Foxnoid, I decided to use some placeholder graphics until I could find a designer to build real graphics for me. In the end I liked my placeholder stuff so much that I decided to keep it. Anyway, I can keep it just because this is a toy game. I don't recommend that you stick with your placeholder graphics.
...
You can fetch the assets from the [Github Repository](https://github.com/firefoxos-gamedev/foxnoid-html5-game) and place them in the correct place.
